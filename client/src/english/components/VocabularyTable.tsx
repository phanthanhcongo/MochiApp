...
export default function VocabularyTable() {
  ...
  // Tạo list level để chọn (đồng bộ 9 cấp)
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50/50">
      ...
      <div className="sticky top-0 w-full z-30">
        <div className="max-w-6xl px-6 py-2.5 mx-auto">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 sm:px-4 rounded-2xl border text-xs font-bold transition-all duration-200 cursor-pointer shadow-sm shrink-0 ${
                  showFilters
              ...
              >
                ...
                {(levelFilter !== 'all' || cefrFilter !== 'all' || typeFilter !== 'all' || activeFilter !== 'all' || topicFilter !== 'all') && (
      ...
      {/* List */}
      <div className="pt-4 pb-10 max-w-6xl mx-auto w-full px-6">
        {filteredWords.map((w) => (
          <div
            key={w.id}
            className={`bg-white border rounded-xl mb-4 border-l-8 ${getLevelBorderClass(w.level)} shadow-sm hover:shadow-md transition-shadow duration-200`}
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div className="md:col-span-4 flex flex-col justify-center border-b md:border-b-0 md:border-r border-gray-100 pb-4 md:pb-0">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className={`px-2 py-1 rounded text-xs font-bold border ${getLevelBadgeClass(w.level)}`}>Level {w.level}</span>
                    {w.cefr_level && (
